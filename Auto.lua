...
getgenv()['Check_Setting'] = function(Name)
    if not _G.Dis and not isfolder('Ghuy Hub BF Premium') then
        makefolder('Ghuy Hub BF Premium')
    end
    if not _G.Dis and not isfile('Ghuy Hub BF Premium/'..Name..'.json') then
        writefile('Ghuy Hub BF Premium/'..Name..'.json',JsonEncode(_G.Setting_table))
    end
end
getgenv()['Get_Setting'] = function(Name)
    if not _G.Dis and isfolder('Ghuy Hub BF Premium') and isfile('Ghuy Hub BF Premium/'..Name..'.json') then
        _G.Setting_table = JsonDecode(readfile('Ghuy Hub BF Premium/'..Name..'.json'))
...
local win = library:Window("Ghuy",[[Hub]],[[Version : Premium ]],"9606070311",Enum.KeyCode.RightControl)
